        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="/cart" class="text-gray-700 hover:text-blue-600">cart <span class="bg-green-600 px-2 py-1 text-white rounded text-xs">{{ $cartCount }}</span></a>
    ...
    <footer class="bg-gray-800 text-white py-12">
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    <h3 class="text-xl font-bold mb-4">MiniMarket</h3>
                    <p class="text-gray-400">Your one-stop shop for all your daily needs.</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li>Email: info@minimarket.com</li>
                    </ul>
                </div>
                <div>
            ...
            <div class="border-t border-gray-700 mt-8 pt-8 text-center text-gray-400">
                <p>&copy; 2024 MiniMarket. All rights reserved.</p>
            </div>
        </div>
    </footer>
    <script>
